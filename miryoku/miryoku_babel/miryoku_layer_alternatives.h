...
U_NP,              U_NP,              &kp DEL,           &kp RET,           &kp BSPC,          &kp BSPC,          U_NA,              U_NA,              U_NP,              U_NP
...
U_NP,              U_NP,              U_NA,              U_NA,              &kp BSPC,          &kp BSPC,          &kp RET,           &kp DEL,           U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV_VI \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         &u_caps_word,      &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         &kp INS,           \
U_NA,              &kp RALT,          &u_to_U_NUM,       &u_to_U_NAV,       U_NA,              &kp HOME,          &kp PG_DN,         &kp PG_UP,         &kp END,           &kp DEL,           \
U_NP,              U_NP,              U_NA,              U_NA,              &kp BSPC,          &kp BSPC,          &kp RET,           &kp DEL,           U_NP,              U_NP
