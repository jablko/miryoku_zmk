...
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, SPACE),U_LT(U_SYM, BSPC), U_LT(U_MOUSE, TAB),U_LT(U_NAV, RET),  U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
U_NP,              U_NP,              &kp DEL,           &kp SPACE,         &kp BSPC,          &kp TAB,           &kp RET,           &kp ESC,           U_NP,              U_NP
...
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp TAB,           &kp RET,           &kp K_APP,         U_NP,              U_NP
